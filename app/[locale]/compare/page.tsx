...
type Props = { params: Promise<{ locale: string }>; searchParams: Promise<{ first?: string }> };
...
export default async function ComparePage({ params, searchParams }: Props) {
  ...
  return <main>
    ...
    {prepared.length ? <section className="section comparison-library">
      ...
      <div className="prepared-comparison-grid">{prepared.map(({ pair, firstProduct, secondProduct }) => <Link className="prepared-comparison-card" href={path(`/compare/${pair}`)} key={pair}>
