    ...
    <section className="section privacy-section">
      ...
      <div className="privacy-content">
        ...
        <article>
          ...
          <p>{c("Die optionale Nutzungsstatistik ist standardmäßig deaktiviert. Erst nach deiner Aktivierung senden wir ausgewählte Ereignisse wie das Öffnen einer Produktseite, den Abschluss des Finders oder einen Vergleich. Suchbegriffe, Parameter in der Adresse und Barcodes werden nicht erfasst.", "Optional usage analytics is disabled by default. Only after you enable it do we send selected events such as opening a product page, completing the Finder, or comparing products. Search terms, address parameters, and barcodes are not collected.")}</p>
