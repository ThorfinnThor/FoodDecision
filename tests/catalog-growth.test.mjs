...
test("pins Node 24 compatible workflow actions to verified release commits", async () => {
  ...
  assert.match(workflows[2], /version: 2\.114\.0/);
  assert.match(workflows[2], /group: supabase-production-migrations/);
  assert.match(workflows[2], /environment: production-database/);
});
