  ...
  return (
    <section className="section" id="score-details">
      ...
      <details className="method-note">
        ...
        <p>{pick(locale, "Das Gesamturteil besteht aus 65 Prozent Nährwerten und 35 Prozent Zutaten. Zucker, Protein und Familientauglichkeit bleiben als eigene Zielbewertungen sichtbar und werden nicht doppelt gezählt.", "The overall score consists of 65 percent nutrition and 35 percent ingredients. Sugar, protein, and family fit remain visible as separate goal scores and are not counted twice.")} {pick(locale, "Ein starker Referenzwert erhält 90 Punkte. Die letzten zehn Punkte sind besseren Spitzenwerten vorbehalten.", "A strong reference value earns 90 points. The final ten points are reserved for stronger standout values.")} {pick(locale, "Regelstand", "Rule version")}: {product.scores[0]?.ruleVersion ?? pick(locale, "aktuell", "current")}.</p>
